...
/// Admin · Conta: card da conta + menu (Cadastros/Taxas) + sair.
class AdminContaScreen extends ConsumerWidget {
  const AdminContaScreen({super.key});
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Symbols.shield, size: 24, color: AppColors.amber),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text('Administração Jurandir',
                                  style: AppText.display(size: 16, weight: FontWeight.w700, letterSpacing: 0)),
                              const SizedBox(height: 1),
                              Text(ref.watch(authProvider).email ?? 'admin@jurandir.app',
  ...
  Widget _menuRow(BuildContext context, IconData icon, String label, String route, {required bool last}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(border: last ? null : Border(bottom: BorderSide(color: AppColors.inkA(0.08)))),
        child: Row(
          children: [
